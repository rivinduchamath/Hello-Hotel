            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Restaurant Delivery Location<br>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br/>
                                        <form action="saveLocation" method="POST" class="form-horizontal form-label-left"
                                              data-parsley-validate id="demo-form3">
                                            <input class="form-control" name="locationId" id="tableId" type="hidden" value="0" >


                                            <div class=" form-group">
                                                <label class="label-align"
                                                       for="unitPrice">Location: <span class="required">* &nbsp; &nbsp; &nbsp;</span>
                                                </label>
                                                <div class="">
                                                    <input class="form-control" id="unitPrice" name="locationNames"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                <table class="table table-striped table-bordered" id="datatable-buttons"
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${loadDeliveryLocations}" var="item">
                                                        <tr>
                                                            <td>${item.locationId}</td>
                                                            <td>${item.locationNames}</td>
                                                            <td><a href="deleteLocation/${item.locationId}">
...
<script>
    ...
    $("#datatable-buttons tbody").on('click', 'tr', function () {
        ...
        $("#unitPrice").val($(this).find("td:nth-child(2)").text());
