                ...
                <div class="table100-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            ...
                            <th class="cell100 column2">Room Type</th>
                            <th class="cell100 column3">Check-In</th>
                            <th class="cell100 column4">Check-Out</th>
                            <th class="cell100 column5">No of Rooms</th>
                        </tr>
                        </thead>
                    </table>
                </div>
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        ...
                        <tr class="row100 body">
                            <td class="cell100 column1">Chamath</td>
                            <td class="cell100 column2">Single</td>
                            <td class="cell100 column3">2020-10-24</td>
                            <td class="cell100 column4">2020-10-28</td>
                            <td class="cell100 column5">1</td>
                        </tr>

                        <tr class="row100 body">
                            <td class="cell100 column1">Amarangi</td>
                        ...
                        <tr class="row100 body">
                            <td class="cell100 column1">Chanuka</td>
                            <td class="cell100 column2">Double</td>
                            <td class="cell100 column3">2020-10-24</td>
                        ...
                        <tr class="row100 body">
                            <td class="cell100 column1">Wusitha</td>
