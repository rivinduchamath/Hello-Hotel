!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = i(2), i(115), i(79), i(10), i(12), i(283), i(272), i(293), i(248), i(244), i(240), i(279), i(288), i(226), i(231), i(237), i(268), i(261), i(36), i(178), i(198), i(308), i(305), i(214), i(189), i(168), i(321), i(184), i(183), i(332), i(190), i(206)
    }, function (t, e, i) {
        function n(t) {
        ...
        var D, P = i(17), k = {
            ...
            }, z = Object.prototype.toString, E = Array.prototype, O = E.forEach, R = E.filter, V = E.slice, N = E.map,
            B = E.reduce, G = {
                inherits: c,
                mixin: d,
                clone: n,
        ...
        var m = i(111), v = i(78), y = i(23), x = i(112), _ = i(10), b = i(13), w = i(54), S = i(26), M = i(3),
            A = i(68), I = i(1), T = i(22), L = i(14), C = i(21), D = I.each, P = ["echarts", "chart", "component"],
        ...
        var V = [], N = {}, B = [], G = {}, F = [], H = {}, W = {}, Z = {}, q = {}, j = new Date - 0, U = new Date - 0,
            X = "_echarts_instance_", Y = {version: "3.1.10", dependencies: {zrender: "3.1.0"}};
        ...
        function g(t, e, i, n, o, a) {
            ...
            var r = t ? "Update" : "", s = n && n.getShallow("animationDuration" + r),
                l = n && n.getShallow("animationEasing" + r), h = n && n.getShallow("animationDelay" + r);
        ...
        a.prototype = {
            constructor: a, type: "path", __dirtyPath: !0, strokeContainThreshold: 5, brush: function (t) {
                t.save();
                var e = this.style, i = this.path, a = o(e), r = n(e), s = r && !!e.fill.colorStops,
        ...
        s.createNameEach = function (t, e) {
            ...
            getDataParams: function (t, e) {
                var i = this.getData(e), n = this.seriesIndex, o = this.name, a = this.getRawValue(t, e),
                    r = i.getRawIndex(t), s = i.getName(t, !0), l = i.getRawDataItem(t);
                return {
        ...
        n.prototype = {
            constructor: n, union: function (t) {
                ...
                var e = this, i = e.x, n = e.x + e.width, o = e.y, a = e.y + e.height, r = t.x, s = t.x + t.width,
                    l = t.y, h = t.y + t.height;
        ...
        function h(t, e) {
            ...
            var i = d.parseDate(e), n = i.getFullYear(), o = i.getMonth() + 1, a = i.getDate(), r = i.getHours(),
        ...
        var o = i(1), a = i(8), r = i(4), s = i(9), l = r.parsePercent, h = o.each, u = {},
        ...
        u.box = n, u.vbox = o.curry(n, "vertical"), u.hbox = o.curry(n, "horizontal"), u.getAvailableSize = function (t, e, i) {
            ...
            var n = e.width, o = e.height, r = l(t.left, n), h = l(t.top, o), u = l(t.right, n), c = l(t.bottom, o),
        ...
        var n = i(1), o = i(9), a = i(7), r = i(10), s = o.encodeHTML, l = o.addCommas, h = r.extend({
            ...
            formatTooltip: function (t, e, i) {
                var o = this._data, a = this.getRawValue(t), r = n.isArray(a) ? n.map(a, l).join(", ") : l(a),
                    h = o.getName(t), u = o.getItemVisual(t, "color"),
        ...
        function i(t) {
            var e = {}, i = {}, n = t.match(/Web[kK]it[\/]{0,1}([\d.]+)/), o = t.match(/(Android);?[\s\/]+([\d.]+)?/),
                a = t.match(/(iPad).*OS\s([\d_]+)/), r = t.match(/(iPod)(.*OS\s([\d_]+))?/),
                s = !a && t.match(/(iPhone\sOS)\s([\d_]+)/), l = t.match(/(webOS|hpwOS)[\s\/]([\d.]+)/),
                h = l && t.match(/TouchPad/), u = t.match(/Kindle\/([\d.]+)/), c = t.match(/Silk\/([\d._]+)/),
                d = t.match(/(BlackBerry).*Version\/([\d.]+)/), f = t.match(/(BB10).*Version\/([\d.]+)/),
                p = t.match(/(RIM\sTablet\sOS)\s([\d.]+)/), g = t.match(/PlayBook/),
                m = t.match(/Chrome\/([\d.]+)/) || t.match(/CriOS\/([\d.]+)/), v = t.match(/Firefox\/([\d.]+)/),
                y = n && t.match(/Mobile\//) && !m, x = t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/) && !m,
                _ = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/.+?rv:(([\d.]+))/), b = t.match(/Edge\/([\d.]+)/);
        ...
        (function (e) {
            ...
            var a = "undefined", r = "undefined" == typeof window ? e : window,
                s = typeof r.Float64Array === a ? Array : r.Float64Array,
                l = typeof r.Int32Array === a ? Array : r.Int32Array,
                h = {"float": s, "int": l, ordinal: Array, number: Array, time: Array}, u = i(12), c = i(48), d = i(1),
                f = i(7), p = d.isObject, g = ["stackedOn", "_nameList", "_idList", "_rawData"], m = function (t, e) {
            ...
            y.type = "list", y.getDimension = function (t) {
                ...
                this._rawData = t;
                var n = this._storage = {}, o = this.indices = [], a = this.dimensions, r = t.length,
        ...
        function s(t, e, i, o, a, r) {
            var s = o + 3 * (e - i) - t, l = 3 * (i - 2 * e + t), h = 3 * (e - t), u = t - a, c = l * l - 3 * s * h,
            ...
            if (n(c) && n(d)) if (n(l)) r[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var I = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), T = Math.acos(I) / 3, L = b(c),
                        C = Math.cos(T), g = (-l - 2 * L * C) / (3 * s), y = (-l + L * (C + M * Math.sin(T))) / (3 * s),
        ...
        function h(t, e, i, n, o, a) {
            var r = (e - t) * o + t, s = (i - e) * o + e, l = (n - i) * o + i, h = (s - r) * o + r, u = (l - s) * o + s,
                c = (u - h) * o + h;
        ...
        function u(t) {
            var e = (parseFloat(t[0]) % 360 + 360) % 360 / 360, n = r(t[1]), o = r(t[2]),
                a = .5 >= o ? o * (n + 1) : o + n - o * n, l = 2 * o - a,
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var a = t * (e.length - 1), r = Math.floor(a), s = Math.ceil(a), u = h(e[r]), c = h(e[s]), d = a - r,
        ...
        h.getScaleExtent = function (t, e) {
            ...
            var a = e.getMin ? e.getMin() : e.get("min"), l = e.getMax ? e.getMax() : e.get("max"),
                h = e.getNeedCrossZero ? e.getNeedCrossZero() : !e.get("scale"), u = e.get("boundaryGap");
            ...
            var i = t.scale, n = h.getScaleExtent(t, e), o = null != (e.getMin ? e.getMin() : e.get("min")),
                a = null != (e.getMax ? e.getMax() : e.get("max")), r = e.get("splitNumber");
        ...
        var n = i(3), o = i(8), a = n.extendShape({
            ...
            type: "pin", shape: {x: 0, y: 0, width: 0, height: 0}, buildPath: function (t, e) {
                var i = e.x, n = e.y, o = e.width / 5 * 3, a = Math.max(o, e.height), r = o / 2, s = r * r / (a - r),
                    l = n - a + r + s, h = Math.asin(s / r), u = Math.cos(h) * r, c = Math.sin(h), d = Math.cos(h);
        ...
        "use strict";
        var n = i(16), o = i(5), a = i(65), r = i(8), s = i(33).devicePixelRatio,
        ...
        _.prototype = {
            ...
            _dashedLineTo: function (t, e) {
                var i, n, o = this._dashSum, a = this._dashOffset, r = this._lineDash, s = this._ctx, l = this._xi,
                    h = this._yi, u = t - l, c = e - h, d = v(u * u + c * c), g = l, m = h, y = r.length;
                    ...
                    switch (1 == d && (n = s[d], o = s[d + 1], e = n, i = o), f) {
                        ...
                        case l.A:
                            var p = s[d++], v = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], S = s[d++],
                                M = s[d++], A = x > _ ? x : _, I = x > _ ? 1 : x / _, T = x > _ ? _ / x : 1,
        ...
        function a(t, e, i) {
            ...
            var v, y = s && s.categoryAxisModel, x = "ordinal" === d[0].type ? 0 : "ordinal" === d[1].type ? 1 : -1,
                _ = new h(d, e), b = l(s, t), w = y && o(t) ? function (t, e, i, n) {
        ...
        var h = i(15), u = i(31), c = i(1), d = i(7), f = i(23), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                ...
                var a = n.get("type"), l = o.get("type"),
                    h = [{name: "x", type: s(a), stackable: r(a)}, {name: "y", type: s(l), stackable: r(l)}],
                    c = "category" === a;
                return u(h, t, ["x", "y", "z"]), {
                    dimensions: h,
                    categoryIndex: c ? 0 : 1,
                ...
                var h = l.get("type"), c = a.get("type"), d = [{name: "radius", type: s(h), stackable: r(h)}, {
                    name: "angle",
                    type: s(c),
                    stackable: r(c)
                }], f = "category" === c;
        ...
        var a = i(1), r = i(14), s = i(2), l = i(7), h = i(169), u = a.each, c = l.eachAxisDim,
            d = s.extendComponentModel({
                ...
                doInit: function (t) {
                    var e = this.option;
                    r.canvasSupported || (e.realtime = !1), o("start", "startValue", t


                        , e), o("end", "endValue", t, e), this.textStyleModel = this.getModel("textStyle"), this._resetTarget(), this._giveAxisProxies()
                },
        ...
        u._updateCommon = function (t, e, i) {
            var o = this.childAt(0), a = t.hostModel, s = t.getItemModel(e), u = s.getModel(c),
        ...
        var r = i(1), s = i(3), l = i(12), h = i(4), u = h.remRadian, c = h.isRadianAroundZero, d = Math.PI,
            f = function (t, e) {
        ...
        var p = {
            axisLine: function () {
                ...
                if (e.get("axisLabel.show")) {
                    var i = this.opt, a = e.axis, r = e.getModel("axisLabel"), h = r.getModel("textStyle"),
                        u = r.get("margin"), c = a.scale.getTicks(), f = e.getFormattedLabels(), p = i.labelRotation;
                    ...
                    for (var m = o(i, p, i.labelDirection), v = e.get("data"), y = [], x = e.get("silent"), _ = 0; _ < c.length; _++) if (!g(a, _, i.labelInterval)) {
                        ...
                        var w = b.getTextColor(), S = a.dataToCoord(c[_]),
                            M = [S, i.labelOffset + i.labelDirection * u], A = a.scale.getLabel(c[_]), I = new s.Text({
                                style: {
                                    text: f[_],
                ...
                if (null == i && (i = e.get("name")), i) {
                    var r, l = e.get("nameLocation"), h = t.nameDirection, u = e.getModel("nameTextStyle"),
                        c = e.get("nameGap") || 0, d = this.axisModel.axis.getExtent(), f = d[0] > d[1] ? -1 : 1,
        ...
        var s = i(11), l = i(24), h = i(1), u = i(106), c = i(104), d = h.each, f = l.ifAxisCrossZero,
            p = l.niceScaleExtent;
        i(107);
        var g = a.prototype;
        g.type = "grid", g.getRect = function () {
            ...
            h.each(this._axesList, function (t) {
                ...
                if ("cartesian2d" === o.get("coordinateSystem")) {
                    var a = o.get("xAxisIndex"), r = o.get("yAxisIndex"), s = t.getComponent("xAxis", a),
        ...
        var n = i(5), o = i(16), a = {}, r = Math.min, s = Math.max, l = Math.sin, h = Math.cos, u = n.create(),
        ...
        a.fromCubic = function (t, e, i, n, a, l, h, u, c, d) {
            ...
            var c = o.quadraticExtremum, d = o.quadraticAt, f = s(r(c(t, i, a), 1), 0), p = s(r(c(e, n, l), 1), 0),
                g = d(t, i, a, f), m = d(e, n, l, p);
        ...
        l.prototype = {
            constructor: l, drawRectText: function (t, e, i) {
                ...
                if (null != l && (l += ""), l) {
                    var h, u, c = r.textPosition, d = r.textDistance, f = r.textAlign, p = r.textFont || r.font,
                        g = r.textBaseline, m = r.textVerticalAlign;
        ...
        var o = i(58), a = i(14), r = i(126), s = i(129), l = i(130), h = !a.canvasSupported, u = {canvas: i(128)},
            c = {}, d = {};
        ...
        var n = i(1), o = {
            ...
            }, a = n.merge({boundaryGap: !0, axisTick: {interval: "auto"}, axisLabel: {interval: "auto"}}, o),
            r = n.defaults({boundaryGap: [0, 0], splitNumber: 5}, o),
            s = n.defaults({scale: !0, min: "dataMin", max: "dataMax"}, r), l = n.defaults({}, r);
        ...
        t.exports = function (t, e, i) {
            function o(t) {
                var o = [e, "normal", "color"], a = i.get("color"), r = t.getData(),
        ...
        t.exports = n.extend({
            ...
            getMarkerPosition: function (t) {
                ...
                if (e) {
                    var i = e.dataToPoint(t), n = this.getData(), o = n.getLayout("offset"), a = n.getLayout("size"),
        ...
        o.extend(i(12).prototype, i(82)), t.exports = i(2).extendChartView({
            type: "bar", render: function (t, e, i) {
                ...
                var s = this.group, l = t.getData(), h = this._data, u = t.coordinateSystem, c = u.getBaseAxis(),
                ...
                e.eachItemGraphicEl(function (r, s) {
                    var l = e.getItemModel(s), h = e.getItemVisual(s, "color"), u = e.getItemVisual(s, "opacity"),
                    ...
                    var p = i ? c.height > 0 ? "bottom" : "top" : c.width > 0 ? "left" : "right",
                        g = l.getModel("label.normal"), m = l.getModel("label.emphasis"), v = r.style;
        ...
        var h = i(25), u = i(5), c = i(164), d = i(3), f = i(1), p = i(4), g = ["fromSymbol", "toSymbol"],
            m = l.prototype;
        m.beforeUpdate = s, m._createLine = function (t, e) {
            ...
            var i = t.hostModel, n = this.childOfName("line"), o = t.getItemModel(e), a = o.getModel("label.normal"),
                r = a.getModel("textStyle"), s = o.getModel("label.emphasis"), l = s.getModel("textStyle"),
        ...
        function s(t, e) {
            var i = t.getBaseAxis(), n = t.getOtherAxis(i), o = i.onZero ? 0 : n.scale.getExtent()[0], a = n.dim,
                s = "x" === a || "radius" === a ? 1 : 0;
        ...
        function h(t, e, i) {
            var n = a(t.getAxis("x")), o = a(t.getAxis("y")), r = t.getBaseAxis().isHorizontal(),
                s = Math.min(n[0], n[1]), l = Math.min(o[0], o[1]), h = Math.max(n[0], n[1]) - s,
                u = Math.max(o[0], o[1]) - l, c = i.get("lineStyle.normal.width") || 2,
        ...
        function u(t, e, i) {
            var n = t.getAngleAxis(), o = t.getRadiusAxis(), a = o.getExtent(), r = n.getExtent(), s = Math.PI / 180,
                l = new m.Sector({
                    shape: {
                        cx: t.cx,
                        cy: t.cy,
        ...
        t.exports = y.extend({
            type: "line", init: function () {
                ...
                var a = t.coordinateSystem, r = this.group, l = t.getData(), h = t.getModel("lineStyle.normal"),
                    u = t.getModel("areaStyle.normal"), f = l.mapArray(l.getItemLayout, !0), p = "polar" === a.type,
                    g = this._coordSys, m = this._symbolDraw, v = this._polyline, y = this._polygon,
                    x = this._lineGroup, _ = t.get("animation"), b = !u.isEmpty(), w = s(a, l), S = t.get("showSymbol"),
                    M = S && !p && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, a), A = this._data;
                ...
                var o = this._polyline, a = this._polygon, r = t.hostModel,
        ...
        t.exports = {
            ...
            Polygon: r.extend({
                ...
                buildPath: function (t, e) {
                    var i = e.points, r = e.stackedOnPoints, s = 0, l = i.length, h = e.smoothMonotone,
                        u = a(i, e.smoothConstraint), c = a(r, e.smoothConstraint);
                    if (e.connectNulls) {
                        for (; l > 0 && n(i[l - 1]); l--) ;
                        for (; l > s && n(i[s]); s++) ;
                    }
        ...
        function o(t, e, i, n, o) {
            var a = (e.startAngle + e.endAngle) / 2, r = Math.cos(a), s = Math.sin(a), l = i ? n : 0,
                h = [r * l, s * l];
        ...
        h.updateData = function (t, e, i) {
            ...
            var r = this.childAt(0), h = t.hostModel, u = t.getItemModel(e), c = t.getItemLayout(e),
                d = l.extend({}, c);
            ...
            var i = this.childAt(1), n = this.childAt(2), o = t.hostModel, a = t.getItemModel(e),
            ...
            var c = a.getModel("label.normal"), d = a.getModel("label.emphasis"), f = a.getModel("labelLine.normal"),
                p = a.getModel("labelLine.emphasis"), g = c.get("position") || d.get("position");
        ...
        var u = i(26).extend({
            type: "pie", init: function () {
                ...
                if (!o || o.from !== this.uid) {
                    var r = t.getData(), s = this._data, h = this.group, u = e.get("animation"), c = !s,
                        d = l.curry(n, this.uid, t, u, i), f = t.get("selectedMode");
                    if (r.diff(s).add(function (t) {
                        ...
                        var p = r.getItemLayout(0), g = Math.max(i.getWidth(), i.getHeight()) / 2,
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                var D = g.getModel("textStyle").getFont(), P = g.get("rotate") ? 0 > b ? -_ + Math.PI : -_ : 0,
                    k = t.getFormattedLabel(i, "normal") || l.getName(i), z = a.getBoundingRect(k, D, d, "top");
                u = !!P, f.label = {
                    x: n,
                    y: o,
                    position: m,
        ...
        t.exports = function (t, e, i) {
            e.eachSeriesByType(t, function (t) {
                ...
                var u = i.getWidth(), c = i.getHeight(), d = Math.min(u, c), f = o(e[0], u), p = o(e[1], c),
                    g = o(h[0], d / 2), m = o(h[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l,
        ...
        function n(t, e) {
            ...
            var n = t.coordinateSystem, o = e.axis, a = {}, r = o.position, s = o.onZero ? "onZero" : r, l = o.dim,
                h = n.getRect(), u = [h.x, h.x + h.width, h.y, h.y + h.height],
                c = {x: {top: u[2], bottom: u[3]}, y: {left: u[0], right: u[1]}};
        ...
        var o = i(1), a = i(3), r = i(49), s = r.ifIgnoreOnTick, l = r.getInterval,
            h = ["axisLine", "axisLabel", "axisTick", "axisName"], u = ["splitLine", "splitArea"],
            c = i(2).extendComponentView({
                type: "axis", render: function (t, e) {
                    ...
                    var n = t.axis, r = t.getModel("splitLine"), h = r.getModel("lineStyle"), u = h.get("width"),
                        c = h.get("color"), d = l(r, i);
                    c = o.isArray(c) ? c : [c];
                    ...
                    var n = t.axis, r = t.getModel("splitArea"), h = r.getModel("areaStyle"), u = h.get("color"),
                        c = e.coordinateSystem.getRect(), d = n.getTicksCoords(), f = n.toGlobalCoord(d[0]),
                        p = n.toGlobalCoord(d[0]), g = [], m = 0, v = l(r, i);
                    u = o.isArray(u) ? u : [u];
        ...
        t.exports = {
            layout: function (t, e, i) {
                ...
                var i = a.normalizeCssArray(e.get("padding")), n = t.getBoundingRect(),
        ...
        var a = i(1), r = i(4), s = a.indexOf, l = a.curry,
            h = {min: l(o, "min"), max: l(o, "max"), average: l(o, "average")}, u = function (t, e) {
        ...
        function o(t, e) {
            ...
            return r.each(i, function (t, e) {
                o[e] = {};
                var i = t.stacks, n = t.axis, a = n.getBandWidth(), s = l(t.categoryGap, a), h = l(t.gap, 1),
                    u = t.remainedWidth, c = t.autoWidthCount, d = (u - s) / (c + (c - 1) * h);
        ...
        function a(t, e, i) {
            ...
            e.eachSeriesByType(t, function (t) {
                var e = t.getData(), i = t.coordinateSystem, o = i.getBaseAxis(), r = n(t), l = a[o.index][r],
                    h = l.offset, u = l.width, c = i.getOtherAxis(o), d = t.get("barMinHeight") || 0,
        ...
        t.exports = function (t, e) {
            ...
            var i = new n.Rect({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4}), r = new n.Arc({
        ...
        var c = i(1), d = i(7), f = i(12), p = c.each, g = c.filter, m = c.map, v = c.isArray, y = c.indexOf,
            x = c.isObject, _ = i(10), b = i(113), w = "\x00_ec_inner", S = f.extend({
        ...
        var r = i(1), s = i(120), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        ...
        t.exports = function (t, e, o) {
            e.eachSeriesByType(t, function (t) {
                ...
                if ("cartesian2d" === a.type && o) {
                    var r = a.getBaseAxis(), s = a.getOtherAxis(r), l = r.getExtent(), h = l[1] - l[0],
        ...
        var n = i(1), o = i(32), a = i(4), r = i(38), s = o.prototype, l = r.prototype, h = Math.floor, u = Math.ceil,
            c = Math.pow, d = 10, f = Math.log, p = o.extend({
        ...
        var n = i(1), o = i(4), a = i(9), r = i(38), s = r.prototype, l = Math.ceil, h = Math.floor, u = 1e3,
            c = 60 * u, d = 60 * c, f = 24 * d, p = function (t, e, i, n) {
                ...
                type: "time", getLabel: function (t) {
                    ...
                    t = t || 10;
                    var e = this._extent, i = e[1] - e[0], n = i / t, a = m.length, r = p(m, n, 0, a),
                        s = m[Math.min(r, a - 1)], u = s[2];
                    if ("year" === s[0]) {
        ...
        var c = i(14), d = i(34), f = i(1), p = i(155), g = i(138), m = i(21),
            v = ["click", "dblclick", "mousewheel", "mouseout"];
        !l() && v.push("mouseup", "mousedown", "mousemove");
        var y = ["touchstart", "touchend", "touchmove"], x = ["pointerdown", "pointerup", "pointermove"], _ = 300,
            b = d.addEventListener, w = d.removeEventListener, S = d.normalizeEvent, M = {
        ...
        s.prototype = {
            constructor: s, elCount: 0, __dirty: !0, initContext: function () {
                ...
                var e = this.dom, i = this.ctx, n = e.width, o = e.height, a = this.clearColor,
        ...
        var u = i(33), c = i(1), d = i(45), f = i(8), p = i(127), g = new f(0, 0, 0, 0), m = new f(0, 0, 0, 0),
            v = function (t, e, i) {
            ...
            for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case h.Q:
                        ...
                        break;
                    case h.A:
                        var w = t[_++], S = t[_++], M = t[_++], A = t[_++], I = t[_++], T = t[_++],
                            L = (t[_++], 1 - t[_++]), C = Math.cos(I) * M + w, D = Math.sin(I) * A + S;
        ...
        var h = i(28).CMD, u = i(135), c = i(134), d = i(137), f = i(133), p = i(57).normalizeRadian, g = i(16),
            m = i(75), v = u.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        n.prototype = {
            ...
            createLinearGradient: function (t, e, i) {
                var n = e.x * i.width + i.x, o = e.x2 * i.width + i.x, a = e.y * i.height + i.y,
                    r = e.y2 * i.height + i.y, s = t.createLinearGradient(n, a, o, r);
                return s
            },
            createRadialGradient: function (t, e, i) {
                var n = i.width, o = i.height, a = Math.min(n, o), r = e.x * n + i.x, s = e.y * o + i.y, l = e.r * a,
        ...
        var o = i(16), a = i(5), r = o.quadraticSubdivide, s = o.cubicSubdivide, l = o.quadraticAt, h = o.cubicAt,
            u = o.quadraticDerivativeAt, c = o.cubicDerivativeAt, d = [];
        t.exports = i(6).extend({
            type: "bezier-curve",
            shape: {x1: 0, y1: 0, x2: 0, y2: 0, cpx1: 0, cpy1: 0, percent: 1},
            style: {stroke: "#000", fill: null},
            buildPath: function (t, e) {
                var i = e.x1, n = e.y1, o = e.x2, a = e.y2, l = e.cpx1, h = e.cpy1, u = e.cpx2, c = e.cpy2,
                    f = e.percent;
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function (t, e) {
                var i = e.cx, n = e.cy, o = Math.max(e.r0 || 0, 0), a = Math.max(e.r, 0), r = e.startAngle,
                    s = e.endAngle, l = e.clockwise, h = Math.cos(r), u = Math.sin(r);
        ...
        function n(t, e, i, n, o, a, r, s, l, h, u) {
            var g = l * (p / 180), y = f(g) * (t - i) / 2 + d(g) * (e - n) / 2,
                x = -1 * d(g) * (t - i) / 2 + f(g) * (e - n) / 2, _ = y * y / (r * r) + x * x / (s * s);
            _ > 1 && (r *= c(_), s *= c(_));
            var b = (o === a ? -1 : 1) * c((r * r * (s * s) - r * r * (x * x) - s * s * (y * y)) / (r * r * (x * x) + s * s * (y * y))) || 0,
                w = b * r * x / s, S = b * -s * y / r, M = (t + i) / 2 + f(g) * w - d(g) * S,
                A = (e + n) / 2 + d(g) * w + f(g) * S, I = v([1, 0], [(y - w) / r, (x - S) / s]),
                T = [(y - w) / r, (x - S) / s], L = [(-1 * y - w) / r, (-1 * x - S) / s], C = v(T, L);
        ...
        var r = i(6), s = i(28), l = i(157), h = i(19),
        ...
        var o = i(15), a = i(31), r = i(267), s = i(1), l = {
            _baseAxisDim: null, getInitialData: function (t, e) {
                var i, r, s = e.getComponent("xAxis", this.get("xAxisIndex")),
                    l = e.getComponent("yAxis", this.get("yAxisIndex")), h = s.get("type"), u = l.get("type");
        ...
        var v = i(21), y = i(1), x = i(3), _ = y.bind, b = y.each, w = Math.min, S = Math.max, M = Math.pow, A = 1e4,
            I = 2, T = ["mousedown", "mousemove", "mouseup"];
        n.prototype = {
        ...
        var L = {
            line: {
                ...
                create: p, getRanges: function () {
                    var t = m.call(this), e = [w(t[1][0], t[0][0]), w(t[1][1], t[0][1])],
        ...
        i(2).extendChartView({
            type: "scatter", init: function () {
                ...
                var n = t.getData(), o = this._largeSymbolDraw, a = this._normalSymbolDraw, r = this.group,
        ...
        function r(t, e) {
            ...
            if (n) {
                var a = e || 0 === n[0] && 100 === n[1], r = !e && l.getPixelPrecision(o, [0, 500]),
                    s = !(e || 20 > r && r >= 0), h = e || a || s;
            ...
            constructor: c, hostedBy: function (t) {
                ...
                if (t === this._dataZoomModel) {
                    var i = this._dimName, n = this.getTargetSeriesModels(), o = t.get("filterMode"),
                        a = this._valueWindow, r = this.getOtherAxisModel();
        ...
        var o = i(1), a = i(3), r = i(125), s = i(41), l = a.Rect, h = i(4), u = h.linearMap, c = i(11), d = i(71),
            f = h.asc, p = o.bind, g = Math.round, m = Math.max, v = o.each, y = 7, x = 1, _ = 30, b = "horizontal",
            w = "vertical", S = 5, M = ["line", "bar", "candlestick", "scatter"], A = s.extend({
                type: "dataZoom.slider", init: function (t, e) {
                    ...
                    var t = this.dataZoomModel, e = this.api, i = this._findCoordRect(),
                        n = {width: e.getWidth(), height: e.getHeight()}, a = this._orient === b ? {
                    ...
                    var t = this.group, e = this._location, i = this._orient,
                        ...
                        a = this._displayables.barGroup, r = (this._dataShadowInfo || {}).otherAxisInverse;
                    ...
                    if (t) {
                        var e = this._size, i = t.series, n = i.getRawData(),
                            o = i.getShadowDim ? i.getShadowDim() : t.otherDim, r = n.getDataExtent(o),
                            s = .3 * (r[1] - r[0]);
                        r = [r[0] - s, r[1] + s];
                        var l = [0, e[1]], h = [0, e[0]], c = [[e[0], 0], [0, 0]], d = h[1] / (n.count() - 1), f = 0,
                    ...
                    var t = this._displayables, e = t.handles = [], i = t.handleLabels = [],
                        n = this._displayables.barGroup, o = this._size;
                    ...
                    function t(t) {
                        var e = a.getTransform(i.handles[t], this.group),
                            s = a.transformDirection(0 === t ? "right" : "left", e), l = this._halfHandleSize + S,
        ...
        t.exports = i(2).extendComponentView({
            type: "legend", init: function () {
                ...
                var u = i.get("itemWidth"), d = i.get("itemHeight"), f = i.isSelected(t), p = new l.Group,
                    g = e.getModel("textStyle"), m = e.get("icon");
        ...
        var l = i(1), h = i(15), u = i(9), c = i(7), d = i(4), f = u.addCommas, p = u.encodeHTML, g = i(103), m = i(84),
            v = function (t, e, i, n) {
                ...
                formatTooltip: function (t) {
                    var e = this._data, i = this.getRawValue(t), n = l.isArray(i) ? l.map(i, f).join(", ") : f(i),
                        o = e.getName(t);
        ...
        var a = i(39), r = i(1), s = i(9), l = i(7), h = i(4), u = s.addCommas, c = s.encodeHTML, d = i(15), f = i(103),
            p = {
                formatTooltip: function (t) {
                    var e = this.getData(), i = this.getRawValue(t), n = r.isArray(i) ? r.map(i, u).join(", ") : u(i),
                        o = e.getName(t);
        ...
        n.extendComponentModel({
            ...
            type: "title", render: function (t, e, i) {
                if (this.group.removeAll(), t.get("show")) {
                    var n = this.group, r = t.getModel("textStyle"), s = t.getModel("subtextStyle"),
                        l = t.get("textAlign"), h = new o.Text({
                            style: {
                                text: t.get("text"),
                                textFont: r.getFont(),
                                fill: r.getTextColor(),
        ...
        (function (e) {
            ...
            t.exports = i(2).extendComponentView({
                type: "toolbox", render: function (t, e, i) {
                    ...
                    function d(n, o, s) {
                        var l = n.getModel("iconStyle"), h = o.getIcons ? o.getIcons() : n.get("icon"),
                            u = n.get("title") || {};
                        if ("string" == typeof h) {
                            var c = h, d = u;
                            h = {}, u = {}, h[s] = c, u[s] = d
                    ...
                    if (f.removeAll(), t.get("show")) {
                        var p = +t.get("itemSize"), g = t.get("feature") || {},
                            m = this._features || (this._features = {}), v = [];
                        a.each(g, function (t, e) {
                            ...
                            if (n && e) {
                                var o = u.getBoundingRect(e, n.font), a = t.position[0] + f.position[0],
                                    r = t.position[1] + f.position[1] + p, s = !1;
        ...
        function r(t, e) {
            ...
            if (n.intersect(i.getRect())) {
                var o = i.getCartesian(e[0].axisIndex, e[1].axisIndex), a = o.pointToData([t[0][0], t[1][0]], !0),
        ...
        function a(t) {
            t = t;
            var e = [], i = t.get("transitionDuration"), a = t.get("backgroundColor"), r = t.getModel("textStyle"),
                s = t.get("padding");
        ...
        var l = i(1), h = i(22), u = i(34), c = i(9), d = l.each, f = c.toCamelCase, p = i(14),
            g = ["", "-webkit-", "-moz-", "-o-"],
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                function s(i, n, o) {
                    var r = e.getAxis(i), s = r.getBandWidth(), h = o[1] - o[0],
                ...
                var n = i.getModel("crossStyle"), o = n.getModel("textStyle"), a = this._tooltipModel,
                    r = this._crossText;
                ...
                var o = this._api, a = t.getData(i), r = a.getItemModel(e), s = this._tooltipModel,
                    l = this._tooltipContent, u = r.getModel("tooltip");
        ...
        var u = {
            dimensions: r.prototype.dimensions, create: function (t, e) {
                ...
                return t.eachComponent("polar", function (t, s) {
                    ...
                    var h = l.getRadiusAxis(), u = l.getAngleAxis(), c = t.findAxisModel("radiusAxis"),
        ...
        if (!i(14).canvasSupported) {
            var n = i(5), o = i(8), a = i(28).CMD, r = i(22), s = i(18), l = i(67), h = i(37), u = i(46), c = i(66),
                d = i(6), f = i(17), p = i(158), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos,
                x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", S = "progid:DXImageTransform.Microsoft",
                M = 21600, A = M / 2, I = 1e5, T = 1e3, L = function (t) {
                    ...
                    for (r = 0; r < t.length;) {
                        switch (o = t[r++], n = "", i = 0, o) {
                            ...
                            case d:
                                ...
                                r++;
                                var F = t[r++], H = E + y(N) * R, W = O + x(N) * V, S = E + y(B) * R, I = O + x(B) * V,
                                    Z = F ? " wa " : " at ";
            ...
            u.prototype.brushVML = function (t) {
                ...
                if (o) {
                    var h = n.x || 0, u = n.y || 0, c = n.width, d = n.height, f = n.sWidth, v = n.sHeight,
                        y = n.sx || 0, x = n.sy || 0, M = f && v, A = this._vmlEl;
            ...
            for (var K = new o, Q = function (t, e, i, n) {
                ...
                if (a) {
                    var r, l, h = o.textAlign, u = Y(o.textFont),
        ...
        t.exports = function (t) {
            ...
            if (!e || "view" === e.type) {
                var i = e.getBoundingRect(), o = t.getData(), a = o.graph, r = 0, s = o.getSum("value"),
                    l = 2 * Math.PI / (s || o.count()), h = i.width / 2 + i.x, u = i.height / 2 + i.y,
                ...
                a.eachNode(function (t) {
                    ...
                    var e, i = t.getModel().get("lineStyle.normal.curveness") || 0, o = n.clone(t.node1.getLayout()),
                        a = n.clone(t.node2.getLayout()), r = (o[0] + a[0]) / 2, s = (o[1] + a[1]) / 2;
        ...
        t.exports = function (t) {
            t.eachEdge(function (t) {
                var e = t.getModel().get("lineStyle.normal.curveness") || 0, i = n.clone(t.node1.getLayout()),
                    o = n.clone(t.node2.getLayout()), a = [i, o];
        ...
        r.prototype = {
            constructor: r, draw: function (t, e, i, r, s) {
                var u = t.getData && t.getData(), c = t.coordinateSystem, d = this.group, f = c.scale,
                ...
                h.each(c.regions, function (e) {
                    ...
                    i.add(o);
                    var a, r = t.getRegionModel(e.name) || t, s = r.getModel(g), c = r.getModel(m), p = n(s, f),
                        x = n(c, f), _ = r.getModel(v), b = r.getModel(y);
                    if (u) {
                    ...
                    var A = _.get("show"), I = b.get("show"), T = u && isNaN(u.get("value", a)),
                        L = u && u.getItemLayout(a);
                    if (!u || T && (A || I) || L && L.showLabel) {
                        var C = u ? a : e.name, D = t.getFormattedLabel(C, "normal"),
        ...
        var o = i(1), a = i(14), r = i(2), s = i(7), l = i(351), h = i(73), u = h.mapVisual, c = h.eachVisual, d = i(4),
            f = o.isArray, p = o.each, g = d.asc, m = d.linearMap, v = r.extendComponentModel({
                type: "visualMap",
                dependencies: ["series"],
                dataBound: [-(1 / 0), 1 / 0],
                ...
                completeVisualOption: function () {
                    ...
                    var n = this.option, a = {inRange: n.inRange, outOfRange: n.outOfRange},
        ...
        function n(t, e, i) {
            var n = e.getItemModel(i), o = n.getModel(h), a = e.getItemVisual(i, "color"),
        ...
        function o(t) {
            var e, i, n = t.axis, o = t.seriesModels, a = o.length, s = t.boxWidthList = [], u = t.boxOffsetList = [],
                c = [];
        ...
        function a(t, e, i) {
            ...
            o.each(a, function () {
                ...
                var h = arguments, u = a.length, c = h[0], d = h[u], f = "horizontal" === r ? 0 : 1, p = 1 - f,
                    g = t(h[3]), m = t(h[1]), v = t(h[5]), y = [[m, t(h[2])], [v, t(h[4])]];
                l(m), l(v), l(g);
                var x = [];
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("candlestick", function (t) {
                ...
                n.each(o, function () {
                    ...
                    var s = arguments, l = o.length, h = s[0], u = s[l], c = "horizontal" === a ? 0 : 1, d = 1 - c,
                        f = s[1], p = s[2], g = s[3], m = s[4], v = Math.min(f, p), y = Math.max(f, p), x = t(v),
                        _ = t(y), b = t(g), w = t(m), S = [[w, _], [b, x]], M = [];
        ...
        var i = ["itemStyle", "normal", "borderColor"], n = ["itemStyle", "normal", "borderColor0"],
            o = ["itemStyle", "normal", "color"], a = ["itemStyle", "normal", "color0"];
        t.exports = function (t, e) {
        ...
        function o(t, e, i, n) {
            var o = n.getModel("textStyle"), a = n.get("position"),
        ...
        s.updateData = function (t, e, i) {
            var n = this.childAt(0), o = t.hostModel, s = t.getItemModel(e), h = t.getItemLayout(e),
            ...
            var i = this.childAt(1), n = this.childAt(2), r = t.hostModel, s = t.getItemModel(e),
                l = t.getItemLayout(e), h = l.label, u = t.getItemVisual(e, "color");
        ...
        function a(t) {
            t.each(function (e) {
                var i, n, o, a, r = t.getItemModel(e), s = r.getModel("label.normal"), l = s.get("position"),
                    h = r.getModel("labelLine.normal"), u = t.getItemLayout(e), c = u.points,
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("funnel", function (t) {
                var i = t.getData(), r = t.get("sort"), h = n(t, e), u = o(i, r),
                    c = [l(t.get("minSize"), h.width), l(t.get("maxSize"), h.width)], d = i.getDataExtent("value"),
                    f = t.get("min"), p = t.get("max");
                null == f && (f = Math.min(d[0], 0)), null == p && (p = d[1]);
                var g = t.get("funnelAlign"), m = t.get("gap"), v = (h.height - m * (i.count() - 1)) / i.count(),
                    y = h.y, x = function (t, e) {
        ...
        function n(t, e) {
            var i = t.get("center"), n = e.getWidth(), o = e.getHeight(), a = Math.min(n, o), r = l(i[0], e.getWidth()),
                s = l(i[1], e.getHeight()), h = l(t.get("radius"), a / 2);
        ...
        var a = i(247), r = i(3), s = i(4), l = s.parsePercent, h = 2 * Math.PI, u = i(26).extend({
            type: "gauge", render: function (t, e, i) {
                ...
                if (a.get("show")) {
                    var s = a.getModel("textStyle"), h = a.get("offsetCenter"), u = o.cx + l(h[0], o.r),
                        c = o.cy + l(h[1], o.r), d = new r.Text({
                            style: {
                                x: u,
                                y: c,
                ...
                if (h.get("show")) {
                    var d = h.getModel("textStyle"), f = h.get("offsetCenter"), p = a.cx + l(f[0], a.r),
                        g = a.cy + l(f[1], a.r), m = l(h.get("width"), a.r), v = l(h.get("height"), a.r),
                        y = t.getData().get("value", 0), x = new r.Rect({
            ...
            formatTooltip: function (t, e, i) {
                if ("edge" === i) {
                    var n = this.getData(), o = this.getDataParams(t, i), a = n.graph.getEdgeByIndex(t),
                        r = n.getName(a.node1.dataIndex), s = n.getName(a.node2.dataIndex), h = r + " > " + s;
        ...
        i(2).extendChartView({
            type: "graph", init: function (t, e) {
                ...
                var i = this._nodeScaleRatio, n = this.group.scale, o = n && n[0] || 1, a = e.getZoom(),
                    r = (a - 1) * i + 1;
                return r / o
            }, updateLayout: function (t) {
        ...
        t.exports = function (t) {
            t.eachSeriesByType("graph", function (t) {
                ...
                i.each(function (t) {
                    o[i.getName(t)] = t;
                    var n = i.getItemModel(t), a = i.getRawIndex(t),
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("graph", function (t) {
                ...
                if (!e || "view" === e.type) if ("force" === t.get("layout")) {
                    var i = t.preservedPoints || {}, l = t.getGraph(), h = l.data, u = l.edgeData,
                        c = t.getModel("force"), d = c.get("initLayout");
                    t.preservedPoints ? h.each(function (t) {
                        var e = h.getId(t);
                        h.setItemLayout(t, i[e] || [NaN, NaN])
                    }) : d && "none" !== d ? "circular" === d && r(t) : a(t);
                    var f = h.getDataExtent("value"), p = c.get("repulsion"), g = c.get("edgeLength"),
                        ...
                        }), e = t.coordinateSystem, y = e.getBoundingRect(),
                        x = n(m, v, {rect: y, gravity: c.get("gravity")}), _ = x.step;
                    x.step = function (t) {
        ...
        n.prototype = {
            update: function (t, e, i, n, a, r) {
                var s = this._getBrush(), l = this._getGradient(t, a, "inRange"),
                    h = this._getGradient(t, a, "outOfRange"), u = this.pointSize + this.blurSize, c = this.canvas,
                ...
                var t = this._brushCanvas || (this._brushCanvas = a.createCanvas()), e = this.pointSize + this.blurSize,
                    i = 2 * e;
        ...
        t.exports = i(2).extendChartView({
            type: "heatmap", render: function (t, e, i) {
                ...
                h.each(["x", "y", "z"], function (i, n, o, u) {
                    ...
                    if (!isNaN(o)) {
                        var f = new r.Rect({
                            ...
                            g = c.getModel("itemStyle.emphasis").getItemStyle(), m = c.getModel("label.normal"),
                            v = c.getModel("label.emphasis"), y = e.getRawValue(u), x = "-";
                ...
                var l = i.targetVisuals.inRange, h = i.targetVisuals.outOfRange, u = e.getData(),
                ...
                d.applyTransform(f);
                var p = Math.max(d.x, 0), g = Math.max(d.y, 0), m = Math.min(d.width + d.x, a.getWidth()),
                    v = Math.min(d.height + d.y, a.getHeight()), y = m - p, x = v - g,
        ...
        function a() {
            var t = this.__p1, e = this.__p2, i = this.__cp1, n = this.__t, o = this.position, a = u.quadraticAt,
        ...
        d.stopEffectAnimation = function () {
            ...
            var r = this.childAt(1), s = t.getItemModel(e), h = t.getItemVisual(e, "symbol"),
                u = n(t.getItemVisual(e, "symbolSize")), c = t.getItemVisual(e, "color");
            ...
            var p = a.get("showEffectOn"), g = s.get("rippleEffect.scale"), m = s.get("rippleEffect.brushType"),
                v = 1e3 * s.get("rippleEffect.period"), y = e / t.count(), x = s.getShallow("z") || 0,
        ...
        t.exports = function (t) {
            t.eachSeriesByType("lines", function (t) {
                ...
                i.each(a, function (t, n, o) {
                    ...
                    var e, a = i.getItemLayout(t), r = n.getItemLayout(t),
        ...
        var n = i(15), o = i(13), a = i(1), r = i(31), s = i(9), l = s.encodeHTML, h = s.addCommas, u = i(61),
            c = i(162), d = o.extend({
                ...
                o.each("value", function (t, e) {
                    if (!isNaN(t)) {
                        ...
                        if (i && i.point) {
                            ...
                            if (!s) {
                                var h = o.getName(e), u = o.getItemModel(e), c = u.getModel("label.normal"),
                                    d = u.getModel("label.emphasis"), f = c.getModel("textStyle"),
                                    p = d.getModel("textStyle"), g = o.getItemGraphicEl(e);
        ...
        t.exports = r.extend({
            ...
            getInitialData: function (t, e) {
                var i = e.getComponent("parallel", this.get("parallelIndex")), r = i.dimensions,
                    s = i.parallelAxisIndex, l = t.data, h = a.map(r, function (t, i) {
        ...
        function n(t, e, i) {
            var n = t.model, o = t.getRect(),
                a = new s.Rect({shape: {x: o.x, y: o.y, width: o.width, height: o.height}}),
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("parallel", function (e) {
                var i = e.getModel("itemStyle.normal"), n = t.get("color"),
                    o = i.get("color") || n[e.seriesIndex % n.length], a = e.get("inactiveOpacity"),
                    r = e.get("activeOpacity"), s = e.getModel("lineStyle.normal").getLineStyle(),
                    l = e.coordinateSystem, h = e.getData(), u = {normal: s.opacity, active: r, inactive: a};
        ...
        t.exports = i(2).extendChartView({
            type: "radar", render: function (t, e, i) {
                ...
                d.diff(f).add(function (e) {
                    ...
                    var n = f.getItemGraphicEl(i), a = n.childAt(0), r = n.childAt(1), s = n.childAt(2),
                    ...
                    var s = d.getItemModel(i), l = e.childAt(0), h = e.childAt(1), u = e.childAt(2),
        ...
        t.exports = i(2).extendChartView({
            type: "sankey", _model: null, render: function (t, e, i) {
                ...
                this._model = t, l.removeAll(), l.position = [h.x, h.y], s.eachNode(function (e) {
                    var i = e.getLayout(), n = e.getModel(), r = n.getModel("label.normal"),
                        s = r.getModel("textStyle"), h = n.getModel("label.emphasis"), c = h.getModel("textStyle"),
                        d = new o.Rect({
                    ...
                    var n = e.getModel("lineStyle.normal"), a = n.get("curveness"), s = e.node1.getLayout(),
                        h = e.node2.getLayout(), u = e.getLayout();
                    i.shape.extent = Math.max(1, u.dy);
                    var d = s.x + s.dx, f = s.y + u.sy + u.dy / 2, p = h.x, g = h.y + u.ty + u.dy / 2,
                        m = d * (1 - a) + p * a, v = f, y = d * a + p * (1 - a), x = g;
                    i.setShape({
                        x1: d,
                        y1: f,
                        x2: p,
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("sankey", function (t) {
                ...
                i.forEach(function (e) {
                    var i = new n({type: "color", mappingMethod: "linear", dataExtent: [o, a], visual: t.get("color")}),
        ...
        n.prototype = {
            constructor: n, render: function (t, e, i) {
                ...
                for (var o = e; o; o = o.parentNode) {
                    var a = o.getModel().get("name"), r = n.getTextRect(a),
        ...
        function o(t, e, i, n, o, l, h, u, c, d) {
            ...
            if (h) {
                var I = h.getLayout();
                if (I && I.isInView) {
                    var T = I.width, L = I.height, C = I.invisible, D = h.getRawIndex(), P = u && u.getRawIndex(),
                        k = x("nodeGroup", m);
                    if (k) {
        ...
        var r = i(1), s = i(3), l = i(48), h = i(160), u = i(294), c = i(70), d = i(8), f = i(19), p = i(349),
            g = r.bind, m = s.Group, v = s.Rect, y = r.each, x = 3, _ = ["label", "normal"], b = ["label", "emphasis"],
            w = 10, S = 1, M = 2;
        t.exports = i(2).extendChartView({
            type: "treemap", init: function (t, e) {
                ...
                if (!(r.indexOf(o, t) < 0)) {
                    ...
                    var a = h.retrieveTargetInfo(n, t), s = n && n.type, l = t.layoutInfo, u = !this._oldTree,
                        c = this._storage, d = "treemapRootToNode" === s && a && c ? {
                ...
                var u = e.getData().tree, c = this._oldTree, d = n(), f = n(), p = this._storage, g = [],
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), a = e.getHeight(), r = t.option, s = r.size || [], l = b(w(r.width, s[0]), n),
                    h = b(w(r.height, s[1]), a),
                    u = m.getLayoutRect(t.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()}),
        ...
        function u(t, e, i, n, o) {
            var a = e === i.width ? 0 : 1, r = 1 - a, s = ["x", "y"], l = ["width", "height"], h = i[s[a]],
                u = e ? t.area / e : 0;
            (o || u > i[l[r]]) && (u = i[l[r]]);
            for (var c = 0, d = t.length; d > c; c++) {
                var f = t[c], p = {}, g = u ? f.getLayout().area / u : 0, m = p[l[r]] = x(u - 2 * n, 0),
                    v = i[s[a]] + i[l[a]] - h, y = c === d - 1 || g > v ? v : g, b = p[l[a]] = x(y - 2 * n, 0);
        ...
        var p = i(1), g = i(4), m = i(11), v = i(160), y = i(8), v = i(160), x = Math.max, _ = Math.min,
        ...
        i(2).extendComponentView({
            type: "angleAxis", render: function (t, e) {
                if (this.group.removeAll(), t.get("show")) {
                    var i = e.getComponent("polar", t.get("polarIndex")), n = t.axis, a = i.coordinateSystem,
                        r = a.getRadiusAxis().getExtent(), l = n.getTicksCoords();
                ...
                for (var o = t.axis, s = t.get("data"), l = t.getModel("axisLabel"), h = l.getModel("textStyle"), u = t.getFormattedLabels(), c = l.get("margin"), d = o.getLabelsCoords(), f = 0; f < i.length; f++) {
                    var p = n[1], g = e.coordToPoint([p + c, d[f]]), m = e.cx, v = e.cy,
                        ...
                        x = Math.abs(g[1] - v) / p < .3 ? "middle" : g[1] > v ? "top" : "bottom", _ = h;
        ...
        var o = i(1), a = i(49), r = i(161), s = ["axisLine", "axisLabel", "axisTick", "axisName"],
            l = i(2).extendComponentView({
                type: "parallelAxis", _selectController: null, render: function (t, e, i, r) {
                    if (!n(t, e, r) && (this.axisModel = t, this.api = i, this.group.removeAll(), t.get("show"))) {
                        var l = e.getComponent("parallel", t.get("parallelIndex")).coordinateSystem,
                            h = t.getAreaSelectStyle(), u = h.width, c = l.getAxisLayout(t.axis.dim),
                            d = o.extend({strokeContainThreshold: u, axisLineSilent: !(u > 0)}, c), f = new a(t, d);
                        o.each(s, f.add, f);
                        var p = f.getGroup();
        ...
        var o = i(1), a = i(3), r = i(49), s = ["axisLine", "axisLabel", "axisTick", "axisName"],
            l = ["splitLine", "splitArea"];
        i(2).extendComponentView({
            type: "radiusAxis", render: function (t, e) {
                if (this.group.removeAll(), t.get("show")) {
                    var i = e.getComponent("polar", t.get("polarIndex")), a = i.coordinateSystem.getAngleAxis(),
                        h = t.axis, u = i.coordinateSystem, c = h.getTicksCoords(), d = a.getExtent()[0],
                        f = h.getExtent(), p = n(u, t, d), g = new r(t, p);
        ...
        t.exports = i(2).extendComponentView({
            type: "radar", render: function (t, e, i) {
                ...
                if (r.length) {
                    var s = t.get("shape"), l = t.getModel("splitLine"), h = t.getModel("splitArea"),
                        u = l.getModel("lineStyle"), c = h.getModel("areaStyle"), d = l.get("show"), f = h.get("show"),
                        p = u.get("color"), g = c.get("color");
        ...
        function a(t, e, i, n, o, a) {
            var r = t.get("symbol"), l = e.get("color"), h = t.get("symbolSize"), u = h / 2,
        ...
        var s = i(1), l = i(3), h = i(11), u = i(317), c = i(315), d = i(25), f = i(24), p = i(8), g = i(19), m = i(4),
        ...
        t.exports = u.extend({
            type: "timeline.slider", init: function (t, e) {
                ...
                if (this.model = t, this.api = i, this.ecModel = e, this.group.removeAll(), t.get("show", !0)) {
                    var o = this._layout(t, i), a = this._createGroup("mainGroup"), r = this._createGroup("labelGroup"),
                ...
                var r = {horizontal: "center", vertical: i >= 0 || "+" === i ? "left" : "right"},
                    s = {horizontal: i >= 0 || "+" === i ? "top" : "bottom", vertical: "middle"},
                    l = {horizontal: 0, vertical: b / 2}, h = "vertical" === o ? a.height : a.width,
                    u = t.getModel("controlStyle"), c = u.get("show"), d = c ? u.get("itemSize") : 0,
                    f = c ? u.get("itemGap") : 0, p = d + f, g = t.get("label.normal.rotate") || 0;
                g = g * b / 180;
                var m, v, y, x, _ = u.get("position", !0), c = u.get("show", !0), w = c && u.get("showPlayBtn", !0),
                    S = c && u.get("showPrevBtn", !0), M = c && u.get("showNextBtn", !0), A = 0, I = h;
                ...
                _(r, function (t, r) {
                    var s = i.dataToCoord(t), h = o.getItemModel(r), u = h.getModel("itemStyle.normal"),
                        c = h.getModel("itemStyle.emphasis"),
                        d = {position: [s, 0], onclick: x(this._changeTimeline, this, r)}, f = a(h, u, e, d);
                ...
                if (o.get("show")) {
                    var a = n.getData(), r = i.scale.getTicks(), s = f.getFormattedLabels(i, o.get("formatter")),
                        h = i.getLabelInterval();
                    _(r, function (n, o) {
                        if (!i.isLabelIgnored(o, h)) {
                            var r = a.getItemModel(o), u = r.getModel("label.normal.textStyle"),
                                c = r.getModel("label.emphasis.textStyle"), d = i.dataToCoord(n), f = new l.Text({
                                    style: {
                                        text: s[o],
                ...
                var r = t.controlSize, s = t.rotation, h = n.getModel("controlStyle.normal").getItemStyle(),
                    u = n.getModel("controlStyle.emphasis").getItemStyle(), c = [0, -r / 2, r, r], d = n.getPlayState(),
                    f = n.get("inverse", !0);
        ...
        var r = i(216), s = i(3), l = i(1), h = i(4), u = i(71), c = i(76), d = i(217), f = h.linearMap,
            p = d.convertDataIndicesToBatch, g = l.each, m = Math.min, v = Math.max, y = 6, x = 6, _ = r.extend({
                type: "visualMap.continuous", init: function () {
                    ...
                    if (e) {
                        var n = e[1 - i];
                        n = null != n ? n + "" : "";
                        var o = this.visualMapModel, a = o.get("textGap"), r = o.itemSize, l = this._shapes.barGroup,
                            h = this._applyTransform([r[0] / 2, 0 === i ? -a : r[1] + a], l),
                            u = this._applyTransform(0 === i ? "bottom" : "top", l), c = this._orient,
                    ...
                    var e = this.visualMapModel, i = this._shapes, o = e.itemSize, a = this._orient, r = this._useHandle,
                        s = d.getItemAlign(e, this.api, o), h = i.barGroup = this._createBarGroup(s);
                    ...
                    var i = this.visualMapModel, n = i.getExtent(), o = i.itemSize, r = [0, o[1]], l = f(t, n, r, !0),
                        h = this._shapes, u = h.indicator;
                    if (u) {
                    ...
                    function t(t) {
                        ...
                        if (e.option.hoverLink) {
                            var n = this._applyTransform([t.offsetX, t.offsetY], this._shapes.barGroup, !0, !0),
                                o = [n[1] - y / 2, n[1] + y / 2], a = [0, i[1]], r = e.getExtent(),
                    ...
                    if (e && null != e.dataIndex) {
                        var i = e.dataModel || this.ecModel.getSeriesByIndex(e.seriesIndex), n = i.getData(e.dataType),
                            o = n.getDimension(this.visualMapModel.getDataDimension(n)), a = n.get(o, e.dataIndex, !0);
        ...
        var n = i(216), o = i(1), a = i(3), r = i(25), s = i(11), l = i(217), h = n.extend({
            type: "visualMap.piecewise", doRender: function () {
                ...
                var e = this.group;
                e.removeAll();
                var i = this.visualMapModel, n = i.get("textGap"), r = i.textStyleModel, l = r.getFont(),
                    h = r.getTextColor(), u = this._getItemAlign(), c = i.itemSize, d = this._getViewData(),
                    f = !d.endsText, p = !f;
        ...
        n.prototype = {
            type: "parallel", constructor: n, _init: function (t, e, i) {
                ...
                u(n, function (t, i) {
                    var n = o[i], r = e.getComponent("parallelAxis", n),
                ...
                var e = this._rect, i = t.get("layout"), n = this._axesMap, o = this.dimensions,
                    a = [e.width, e.height], r = "horizontal" === i ? 0 : 1, s = a[r], h = a[1 - r], d = [0, h];
                u(n, function (t) {
                    var e = t.inverse ? 1 : 0;
                    t.setExtent(d[e], d[1 - e])
                }), u(o, function (t, n) {
                    var a = s * n / (o.length - 1), r = {horizontal: {x: a, y: h}, vertical: {x: 0, y: a}},
                        u = {horizontal: c / 2, vertical: 0}, d = [r[i].x + e.x, r[i].y + e.y], f = u[i],
                        p = l.create();
        ...
        var o = i(72), a = o.valueAxis, r = i(12), s = i(1), l = i(50), h = i(2).extendComponentModel({
            ...
            optionUpdated: function () {
                var t = this.get("boundaryGap"), e = this.get("splitNumber"), i = this.get("scale"),
                    n = this.get("axisLine"), o = this.get("axisTick"), a = this.get("axisLabel"),
                    h = this.get("name.textStyle"), u = this.get("name.show"), c = this.get("name.formatter"),
