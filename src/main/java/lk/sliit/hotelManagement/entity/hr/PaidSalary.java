...
@Entity
public class PaidSalary implements SuperEntity {
    ...
    public PaidSalary(int salaryId, double basicSalary, double etf, double epf, double serviceCharge, double otHours,
